...
def preprocessData():
    with open('nflAllDowns1.csv', "r") as file:
        for line in itertools.islice(file, 1, 6700):
            pass_type = {}
            pass_type["qtr"] = line.split(',')[1]
            pass_type["down"] = line.split(',')[2]
            pass_type["Redzone"] = line.split(',')[3]
            pass_type["ydstogo"] = line.split(',')[4]
            pass_type["ScoreDiff"] = line.split(',')[5]
            training_data.append(tuple((pass_type, line.split(',')[6].strip())))
